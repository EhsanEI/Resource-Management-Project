...
public class SystemConfigurationDAO {
	...
	public static boolean save(businesslogic.support.SystemConfiguration systemConfiguration) throws PersistentException {
		try {
			businesslogic.distribution.resource.OODPersistentManager.instance().saveObject(systemConfiguration);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(businesslogic.support.SystemConfiguration systemConfiguration) throws PersistentException {
		try {
			businesslogic.distribution.resource.OODPersistentManager.instance().deleteObject(systemConfiguration);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(businesslogic.support.SystemConfiguration systemConfiguration) throws PersistentException {
		try {
			businesslogic.distribution.resource.OODPersistentManager.instance().getSession().refresh(systemConfiguration);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(businesslogic.support.SystemConfiguration systemConfiguration) throws PersistentException {
		try {
			businesslogic.distribution.resource.OODPersistentManager.instance().getSession().evict(systemConfiguration);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
