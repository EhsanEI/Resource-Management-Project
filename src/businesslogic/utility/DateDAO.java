...
public class DateDAO {
	...
	public static boolean save(businesslogic.utility.Date date) throws PersistentException {
		try {
			businesslogic.accounting.user.OODPersistentManager.instance().saveObject(date);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(businesslogic.utility.Date date) throws PersistentException {
		try {
			businesslogic.accounting.user.OODPersistentManager.instance().deleteObject(date);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(businesslogic.utility.Date date) throws PersistentException {
		try {
			businesslogic.accounting.user.OODPersistentManager.instance().getSession().refresh(date);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(businesslogic.utility.Date date) throws PersistentException {
		try {
			businesslogic.accounting.user.OODPersistentManager.instance().getSession().evict(date);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
