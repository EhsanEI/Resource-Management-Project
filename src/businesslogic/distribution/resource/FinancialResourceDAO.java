...
public class FinancialResourceDAO {
	...
	public static boolean save(businesslogic.distribution.resource.FinancialResource financialResource) throws PersistentException {
		try {
			businesslogic.distribution.resource.OODPersistentManager.instance().saveObject(financialResource);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(businesslogic.distribution.resource.FinancialResource financialResource) throws PersistentException {
		try {
			businesslogic.distribution.resource.OODPersistentManager.instance().deleteObject(financialResource);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(businesslogic.distribution.resource.FinancialResource financialResource) throws PersistentException {
		try {
			businesslogic.distribution.resource.OODPersistentManager.instance().getSession().refresh(financialResource);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(businesslogic.distribution.resource.FinancialResource financialResource) throws PersistentException {
		try {
			businesslogic.distribution.resource.OODPersistentManager.instance().getSession().evict(financialResource);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
